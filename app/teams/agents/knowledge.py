...
class KnowledgeAgent:
    ...
    def _create_tools(self):
        ...
        @tool
        async def load_knowledge_base_tool(*args, **kwargs):
            return await self.load_knowledge_base(*args, **kwargs)
        load_knowledge_base_tool.__name__ = 'load_knowledge_base'
        tools.append(load_knowledge_base_tool)
