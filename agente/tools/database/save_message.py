...
async def save_message(
    ...
    try:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Role inválido. Use: user, assistant ou system",
                "error_type": "validation"
            }
        ...
        result = {
            ...
            "data": {
                ...
                "media_type": message.media_type.value if message.media_type and hasattr(message.media_type, 'value') else message.media_type,
        ...
        if message.media_url or message.media_data:
            result["media_info"] = {
                ...
                "data_keys": list(message.media_data.keys()) if message.media_data else []
            }
